...
from ikabot.helpers.fileLock import acquire_shipping_lock, release_shipping_lock
...
def evenDistributionMode(session, event, stdin_fd, predetermined_input, telegram_enabled):
    ...
    try:
        ...
        # Call distribute_evenly function
...
def distribute_evenly(session, resource_type, cities_ids, cities):
    """
    Calculate routes to balance a resource evenly across cities.
